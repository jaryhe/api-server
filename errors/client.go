...
func (err errConnectionFailed) Error() string {
	if err.host == "" {
		return "Cannot connect to the Storm daemon. Is the storm daemon running on this host?"
	}
	return fmt.Sprintf("Cannot connect to the Storm daemon at %s. Is the storm daemon running?", err.host)
}

// IsErrConnectionFailed returns true if the error is caused by connection failed.
func IsErrConnectionFailed(err error) bool {
	_, ok := Cause(err).(errConnectionFailed)
	return ok
}

// ErrorConnectionFailed returns an error with host in the error message when connection to storm daemon failed.
...
// object (image, container, network, volume, …) is not found in the storm host.
func IsErrNotFound(err error) bool {
	te, ok := err.(notFound)
	return ok && te.NotFound()
}

// imageNotFoundError implements an error returned when an image is not in the storm host.
...
// when an image is not found in the storm host.
func IsErrImageNotFound(err error) bool {
	return IsErrNotFound(err)
}

// containerNotFoundError implements an error returned when a container is not in the storm host.
...
// when a container is not found in the storm host.
func IsErrContainerNotFound(err error) bool {
	return IsErrNotFound(err)
}

// networkNotFoundError implements an error returned when a network is not in the storm host.
...
// when a network is not found in the storm host.
func IsErrNetworkNotFound(err error) bool {
	return IsErrNotFound(err)
}

// volumeNotFoundError implements an error returned when a volume is not in the storm host.
...
// when a volume is not found in the storm host.
...
// pluginNotFoundError implements an error returned when a plugin is not in the storm host.
...
// when a plugin is not found in the storm host.

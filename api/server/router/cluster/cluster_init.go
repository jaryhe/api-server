...
func (c *Cluster)CreateManageNode() error{

	return nil
}

func (c *Cluster)CreateMetaNode() error{
	return nil
}

func (c *Cluster)CreateClientNode() error{
...
func (c *Cluster) CreateDrdbConfFile() error{
	...
	n,err2 := io.WriteString(f, drdbConfStr)
	if err2 != nil{
		return err2
	}
	return nil
